document.addEventListener("alpine:init", () => {
    Alpine.data("pizzaCart", () => {
        return {
            ...
            message: "",
            featuredPizzas: [],
            historicalOrders: JSON.parse(localStorage.getItem('historicalOrders')) || [],
            ...
            getFilteredHistoricalOrders() {
                return this.historicalOrders.filter(order => order.username === this.username);
            },

            setAsFeatured(pizzaId) {
